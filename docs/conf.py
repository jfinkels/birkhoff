...
# -*- coding: utf-8 -*-
#
# birkhoff documentation build configuration file, created by
...
try:
    release = pkg_resources.get_distribution('birkhoff').version
except pkg_resources.DistributionNotFound:
    print('To build the documentation, the distribution information of')
    print('birkhoff has to be available.  Either install the package')
...
latex_documents = [
  ('index', 'birkhoff.tex', 'birkhoff Documentation',
...
man_pages = [
    ('index', 'birkhoff', 'birkhoff Documentation',
